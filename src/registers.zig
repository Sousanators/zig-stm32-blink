//generated using https://github.com/Fredrik-Reinholdsen/svd4zig
// with https://github.com/modm-io/cmsis-svd-stm32/blob/main/stm32f3/STM32F303.svd
...
pub const NVIC = struct {
    ...
    pub const NVIC_ISER0 = Register(NVIC_ISER0_val).init(base_address + 0x0);
    //NVIC_ISER1
    ...
    pub const NVIC_ISER1 = Register(NVIC_ISER1_val).init(base_address + 0x4);
    //NVIC_ISER2
    const NVIC_ISER2_val = packed struct {
        SETENA0: u1 = 0,
        SETENA1: u1 = 0,
        SETENA2: u1 = 0,
        SETENA3: u1 = 0,
    ...
    pub const NVIC_ISER2 = Register(NVIC_ISER2_val).init(base_address + 0x8);
    //NVIC_ISER3
    const NVIC_ISER3_val = packed struct {
        SETENA0: u1 = 0,
        SETENA1: u1 = 0,
        SETENA2: u1 = 0,
        SETENA3: u1 = 0,
    ...
    pub const NVIC_ISER3 = Register(NVIC_ISER3_val).init(base_address + 0xC);
    //NVIC_ISER4
    const NVIC_ISER4_val = packed struct {
        SETENA0: u1 = 0,
        SETENA1: u1 = 0,
        SETENA2: u1 = 0,
        SETENA3: u1 = 0,
    ...
    pub const NVIC_ISER4 = Register(NVIC_ISER4_val).init(base_address + 0x10);
    //NVIC_ISER5
    const NVIC_ISER5_val = packed struct {
        SETENA0: u1 = 0,
        SETENA1: u1 = 0,
        SETENA2: u1 = 0,
        SETENA3: u1 = 0,
    ...
    pub const NVIC_ISER5 = Register(NVIC_ISER5_val).init(base_address + 0x14);
    //NVIC_ISER6
    const NVIC_ISER6_val = packed struct {
        SETENA0: u1 = 0,
        SETENA1: u1 = 0,
        SETENA2: u1 = 0,
        SETENA3: u1 = 0,
    ...
    pub const NVIC_ISER6 = Register(NVIC_ISER6_val).init(base_address + 0x18);
    //NVIC_ISER7
    const NVIC_ISER7_val = packed struct {
        SETENA0: u1 = 0,
        SETENA1: u1 = 0,
        SETENA2: u1 = 0,
        SETENA3: u1 = 0,
    ...
    pub const NVIC_ISER7 = Register(NVIC_ISER7_val).init(base_address + 0x1C);
    //NVIC_ICER0
    ...
    pub const NVIC_ICER0 = Register(NVIC_ICER0_val).init(base_address + 0x80);
};
...
pub const SYSCFG_COMP_OPAMP = struct {
    ...
    /// SYSCFG_CFGR3
    const SYSCFG_CFGR3_val = packed struct {
        /// SPI1_RX_DMA_RMP [0:1]
        /// SPI1_RX DMA remapping bit
        SPI1_RX_DMA_RMP: u2 = 0,
        /// SPI1_TX_DMA_RMP [2:3]
        /// SPI1_TX DMA remapping bit
        SPI1_TX_DMA_RMP: u2 = 0,
        /// I2C1_RX_DMA_RMP [4:5]
        /// I2C1_RX DMA remapping bit
        I2C1_RX_DMA_RMP: u2 = 0,
        /// I2C1_TX_DMA_RMP [6:7]
        /// I2C1_TX DMA remapping bit
        I2C1_TX_DMA_RMP: u2 = 0,
        /// ADC2_DMA_RMP [8:9]
    ...
    pub const SYSCFG_CFGR3 = Register(SYSCFG_CFGR3_val).init(base_address + 0x50);

    /// SYSCFG_CFGR4
    const SYSCFG_CFGR4_val = packed struct {
        /// ADC12_EXT2_RMP [0:0]
        ...
        /// ADC12_EXT13_RMP [3:3]
        /// Controls the Input trigger of ADC12
        ADC12_EXT13_RMP: u1 = 0,
        /// ADC12_EXT15_RMP [4:4]
        /// Controls the Input trigger of ADC12
        ADC12_EXT15_RMP: u1 = 0,
        /// ADC12_JEXT3_RMP [5:5]
        /// Controls the Input trigger of ADC12
        ADC12_JEXT3_RMP: u1 = 0,
        /// ADC12_JEXT6_RMP [6:6]
        /// Controls the Input trigger of ADC12
        ADC12_JEXT6_RMP: u1 = 0,
        /// ADC12_JEXT13_RMP [7:7]
        /// Controls the Input trigger of ADC12
        ADC12_JEXT13_RMP: u1 = 0,
        /// ADC34_EXT5_RMP [8:8]
        ...
        /// Controls the Input trigger of ADC34
        ADC34_EXT6_RMP: u1 = 0,
        /// ADC34_EXT15_RMP [10:10]
        /// Controls the Input trigger of ADC34
        ADC34_EXT15_RMP: u1 = 0,
        /// ADC34_JEXT5_RMP [11:11]
        /// Controls the Input trigger of ADC34
        ADC34_JEXT5_RMP: u1 = 0,
        /// ADC34_JEXT11_RMP [12:12]
        /// Controls the Input trigger of ADC34
        ADC34_JEXT11_RMP: u1 = 0,
        /// ADC34_JEXT14_RMP [13:13]
        /// Controls the Input trigger of ADC34
        ADC34_JEXT14_RMP: u1 = 0,
        /// unused [14:31]
        _unused14: u2 = 0,
        _unused16: u8 = 0,
        _unused24: u8 = 0,
    ...
    /// SYSCFG configuration register
    pub const SYSCFG_CFGR4 = Register(SYSCFG_CFGR4_val).init(base_address + 0x48);
};
